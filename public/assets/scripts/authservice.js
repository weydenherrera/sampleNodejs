    ...
    init: function init(options) {
      ...
      */
      ...
      $('#authservice-signup-email-button').click(function(){
        $('#authservice-signup-form-email').val($('#authservice-signup-email').val());
      ...
      $('#authservice-login-submit').click(function() {
         username = $('#authservice-login-username').val();
         password = $('#authservice-login-password').val();

         authservice.login(username, password, function(user){
           // Success
           localStorage.clear();
           document.location.href = 'nice_work.html';
           authservice.resetLoginMenu();
         }, function() {
           // Fail
      ...
      $('#authservice-loginEmail-submit').click(function() {
         username = $('#authservice-loginEmail-username').val();
         password = $('#authservice-loginEmail-password').val();
      ...
      $('#authservice-forgot-submit').click(function() {
        username = $('#authservice-forgot-username').val();
      ...
      $('#authservice-register-submit').click(function() {
        username = $('#authservice-register-username').val();
        password = $('#authservice-register-password').val();
